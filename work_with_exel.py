...
excel_file = "C:/Users/user/Desktop/раб/Объекты/143 МСК МО, Б. Вяземы Можайское ш. 7/АПО МСК_МО, Б. Вяземы_Можайское ш. 7.xlsm"
module_name = "Лист15"
macro_name = "AddPhotosToSheet" # Замените на имя вашего макроса


# run_vba_macro(excel_file, module_name, 'DeletePhoto')
# run_vba_macro(excel_file, module_name, macro_name)
